...
INSERT INTO `crypto` (`idcrypto`, `cryptosymbol`, `lastprice`, `cryptoimg`, `marketCap`, `rank`, `cryptoname`, `color`)
VALUES (51, 'BTC', '39070.9626', 'https://cdn.coinranking.com/bOabBYkcX/bitcoin_btc.svg', '741163932216.00', 1,
        'Bitcoin', '#f7931A'),
       (52, 'ETH', '2771.2224', 'https://cdn.coinranking.com/rk4RKHOuW/eth.svg', '330824508297.00', 2, 'Ethereum',
        '#3C3C3D'),
       (53, 'USDT', '1.0028', 'https://cdn.coinranking.com/mgHqwlCLj/usdt.svg', '79772810180.00', 3, 'Tether USD',
        '#22a079'),
       (54, 'BNB', '372.4025', 'https://cdn.coinranking.com/B1N19L_dZ/bnb.svg', '55361944860.00', 4, 'Binance Coin',
        '#e8b342'),
       (55, 'USDC', '1.0010', 'https://cdn.coinranking.com/jkDf8sQbY/usdc.svg', '47898558897.00', 5, 'USDC', '#7894b4'),
       (56, 'HEX', '0.1458', 'https://cdn.coinranking.com/iseN4Am58/hex-vector.svg', '37676078094.00', 6, 'HEX',
        '#ffcd00'),
       ...
       (60, 'ADA', '0.8899', 'https://cdn.coinranking.com/ryY28nXhW/ada.svg', '27686048049.00', 10, 'Cardano',
        '#3cc8c8'),
       (61, 'DOT', '18.2371', 'https://cdn.coinranking.com/RsljYqnbu/polkadot.svg', '19987447832.00', 11, 'Polkadot',
        '#d64cA8'),
       (62, 'BUSD', '1.0019', 'https://cdn.coinranking.com/6SJHRfClq/busd.svg', '18171984500.00', 12, 'Binance USD',
        '#f0b90b'),
       (63, 'AVAX', '78.4416', 'https://cdn.coinranking.com/S0C6Cw2-w/avax-avalanche.png', '17251960322.00', 13,
        'Avalanche', '#e84242'),
       (64, 'DOGE', '0.1269', 'https://cdn.coinranking.com/H1arXIuOZ/doge.svg', '16835065042.00', 14, 'Dogecoin',
        '#c2a633'),
       (65, 'SHIB', '0.0000', 'https://cdn.coinranking.com/D69LfI-tm/shib.png', '14426629462.00', 15, 'SHIBA INU',
        '#fda32b'),
       (66, 'BIT', '1.2280', 'https://cdn.coinranking.com/0ClFW1IpO/bitdao.png', '12279949409.00', 16, 'BitDAO ',
        '#000000'),
       (67, 'UST', '1.0033', 'https://cdn.coinranking.com/mtb0IvtcM/terrausd.png', '11310721128.00', 17, 'TerraUSD',
        '#0e3ca5'),
       (68, 'MATIC', '1.4978', 'https://cdn.coinranking.com/HAf8rW3kx/polygon-matic-rebrand.png', '11289632878.00', 18,
        'Polygon', '#8247e5'),
       (69, 'WBTC', '39069.8815', 'https://cdn.coinranking.com/o3-8cvCHu/wbtc[1].svg', '10262185549.00', 19,
        'Wrapped BTC', ''),
       (70, 'DAI', '1.0017', 'https://cdn.coinranking.com/mAZ_7LwOE/mutli-collateral-dai.svg', '9216717883.00', 20,
        'Dai', ''),
       (71, 'ATOM', '28.6454', 'https://cdn.coinranking.com/HJzHboruM/atom.svg', '8283746707.00', 21, 'Cosmos',
        '#5064fb'),
       (72, 'CRO', '0.4127', 'https://cdn.coinranking.com/2o91jm73M/cro.svg', '7612064794.00', 22, 'Crypto.com Chain',
        '#01275d'),
       (73, 'LTC', '107.7412', 'https://cdn.coinranking.com/BUvPxmc9o/ltcnew.svg', '7512380857.00', 23, 'Litecoin',
        '#345d9d'),
       (74, 'UNI', '10.0895', 'https://cdn.coinranking.com/1heSvUgtl/uniswap-v2.svg?size=48x48', '7033983909.00', 24,
        'Uniswap', '#ff007a'),
       (75, 'LINK', '14.3415', 'https://cdn.coinranking.com/9NOP9tOem/chainlink.svg', '6697605686.00', 25, 'Chainlink',
        '#4680b0'),
       (76, 'TRX', '0.0599', 'https://cdn.coinranking.com/behejNqQs/trx.svg', '6100617518.00', 26, 'TRON', '#eb0029'),
       (77, 'BCH', '314.4690', 'https://cdn.coinranking.com/By8ziihX7/bch.svg', '5973116713.00', 27, 'Bitcoin Cash',
        '#8dc451'),
       (78, 'FTT', '43.3188', 'https://cdn.coinranking.com/WyBm4_EzM/ftx-exchange.svg', '5970143582.00', 28,
        'FTX Token', '#77d9ed'),
       (79, 'LEO', '5.9587', 'https://cdn.coinranking.com/12EKqY08r/leo.svg', '5875102812.00', 29, 'LEO', '#063f35'),
       (80, 'MANA', '2.6669', 'https://cdn.coinranking.com/ph_svUzXs/decentraland(1).svg', '5850708645.00', 30,
        'Decentraland', '#f47e33'),
       (81, 'ALGO', '0.8293', 'https://cdn.coinranking.com/lzbmCkUGB/algo.svg', '5489213937.00', 31, 'Algorand', ''),
       (82, 'STETH', '2723.2143', 'https://cdn.coinranking.com/UJ-dQdgYY/8085.png', '5405490178.00', 32,
        'Lido Staked Ether', '#41c0f5'),
       (83, 'NEAR', '8.8826', 'https://cdn.coinranking.com/Cth83dCnl/near.png', '5399225413.00', 33, 'NEAR Protocol',
        '#000000'),
       (84, 'WEMIX', '5.2793', 'https://cdn.coinranking.com/1N84MQsoO/7548.png', '5279261925.00', 34, 'WEMIX TOKEN',
        '#9bdc70'),
       (85, 'OKB', '17.3713', 'https://cdn.coinranking.com/BJcjC5rCQ/Okex.svg', '4563083241.00', 35, 'OKB', '#2d60e0'),
       (86, 'SENSO', '0.6936', 'https://cdn.coinranking.com/TQFMWwtyn/senso.svg', '4102939994.00', 36, 'SENSO',
        '#000000'),
       (87, 'HBAR', '0.2183', 'https://cdn.coinranking.com/dSCnSLilQ/hedera.svg', '4067058438.00', 37,
        'Hedera HashGraph', '#000000'),
       (88, 'XLM', '0.1893', 'https://cdn.coinranking.com/78CxK1xsp/Stellar_symbol_black_RGB.svg', '3824524409.00', 38,
        'Stellar', '#000000'),
       (89, 'ICP', '18.3152', 'https://cdn.coinranking.com/1uJ_RVrmC/dfinity-icp.png', '3800693162.00', 39,
        'Internet Computer (DFINITY)', '#00042b'),
       (90, 'BLOK', '0.0175', 'https://cdn.coinranking.com/P6P1BdGJ9/11206.png', '3496438705.00', 40, 'Bloktopia',
        '#000000'),
       (91, 'ETC', '28.5961', 'https://cdn.coinranking.com/rJfyor__W/etc.svg', '3326102042.00', 41, 'Ethereum Classic',
        '#699070'),
       (92, 'SAND', '3.0142', 'https://cdn.coinranking.com/kd_vwOcnI/sandbox.png', '3282270477.00', 42, 'The Sandbox',
        '#00adef'),
       (93, 'VET', '0.0476', 'https://cdn.coinranking.com/B1_TDu9Dm/VEN.svg', '3179118079.00', 43, 'VeChain',
        '#4bc0fa'),
       (94, 'CETH', '55.5931', 'https://cdn.coinranking.com/ZTQUl5jrQ/CETH2.svg', '3127880857.00', 44, 'Compound Ether',
        ''),
       (95, 'AXS', '49.7384', 'https://cdn.coinranking.com/L3gWtlUJB/axie-infinity.png', '3029440561.00', 45,
        'Axie Infinity', '#f5a616'),
       (96, 'FTM', '1.6698', 'https://cdn.coinranking.com/Uh-AYdcnU/fantom.png', '2976398750.00', 46, 'Fantom',
        '#1969ff'),
       (97, 'KLAY', '1.1962', 'https://cdn.coinranking.com/cY-BSmXaS/klay.svg', '2928437221.00', 47, 'Klaytn',
        '#4f473b'),
       (98, 'THETA', '2.9173', 'https://cdn.coinranking.com/HJHg2k9Lf/theta.svg', '2917139515.00', 48, 'Theta Token',
        '#1b1f2a'),
       (99, 'XTZ', '3.3167', 'https://cdn.coinranking.com/HkLUdilQ7/xtz.svg', '2911868966.00', 49, 'Tezos', '#2c7df7'),
       (100, 'EGLD', '140.5509', 'https://cdn.coinranking.com/X62ruAuZQ/Elrond.svg', '2862567477.00', 50, 'Elrond',
        '#000000');
...
VALUES (13, '250.00', 'Lapos Dia', '450.00', '350.00', 27, '2022-02-27 18:56:05');
...
VALUES (71, 'alma', 25000, 'Kis Geza', '075252525', 27, '2022-02-27 18:55:38');
...
INSERT INTO `metals` (`idmetals`, `metalsymbol`, `newPrice`)
VALUES (211, 'AED', '3.67'),
       (212, 'AFN', '91.07'),
       (213, 'ALL', '107.68'),
       (214, 'AMD', '477.96'),
...
INSERT INTO `personalcrypto` (`idpersonalcrypto`, `dbkrpto`, `oldcrprice`, `users_id`, `crypto_idcrypto`, `cryptodate`)
VALUES (24, '50.0000', '100.0000', 27, 51, '2022-02-27 18:55:05'),
...
INSERT INTO `personalmetal` (`idpersonalmetal`, `dbmetal`, `oldprice`, `metaldate`, `metals_idmetals`, `users_id`)
VALUES (2, '25.00', '13.00', '2022-02-27 19:45:18', 223, 27),
...
VALUES (25, 'Sherlock', 'Bajnok', 'sherlock_bajnok', 'bajnok@sherlock.ro', '21232f297a57a5a743894a0e4a801fc3',
        '2021-12-02', 'r3.png', '07446544545'),
       (27, 'Kasza', 'Sandor', 'kasza_sandor', 'kasza@kasza.com', '21232f297a57a5a743894a0e4a801fc3', '2021-12-06',
        'r3.png', '0752944514'),
       (36, 'Kis', 'Anna', 'kis_anna', 'anna@anna.com', '21232f297a57a5a743894a0e4a801fc3', '2021-12-23', 'r3.png',
        '07555445'),
       (502, 'Palik', 'Paé', 'kis_paé', 'pal@pal.com', '5f0fa8b7a7397a3c1a5e746578bd3e59', '2022-02-19', 'r3.png',
        '0755055050');
...
INSERT INTO `workplace` (`idworkplace`, `workplacename`, `workplaceaddres`, `users_id`, `salary`, `position`,
                         `workdate`)
VALUES (27, 'Sapientia', 'taploca', 27, '5000.00', 'boss', '2022-02-27 18:55:53');
...
CREATE
ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `kriptonyereseg`  AS
SELECT (`crypto`.`lastprice` - `personalcrypto`.`oldcrprice`) * `personalcrypto`.`dbkrpto` AS `kvagy`,
       `crypto`.`lastprice` * `personalcrypto`.`dbkrpto`                                   AS `ktej`,
       `personalcrypto`.`idpersonalcrypto`                                                 AS `idpersonalcrypto`,
       `crypto`.`lastprice`                                                                AS `lastprice`,
       `personalcrypto`.`dbkrpto`                                                          AS `dbkrpto`,
       `personalcrypto`.`oldcrprice`                                                       AS `oldcrprice`,
       `personalcrypto`.`users_id`                                                         AS `users_id`
FROM (`crypto` join `personalcrypto` on (`crypto`.`idcrypto` = `personalcrypto`.`crypto_idcrypto`));
...
CREATE
ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `kriptoszazalek`  AS
SELECT `crypto`.`lastprice` / `personalcrypto`.`oldcrprice` * 100 AS `kszaz`,
       `personalcrypto`.`idpersonalcrypto`                        AS `idpersonalcrypto`,
       `personalcrypto`.`dbkrpto`                                 AS `dbkrpto`,
       `personalcrypto`.`oldcrprice`                              AS `oldcrprice`,
       `personalcrypto`.`users_id`                                AS `users_id`
...
CREATE
ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `metalsnyereseg`  AS
SELECT (`metals`.`newPrice` - `personalmetal`.`oldprice`) * `personalmetal`.`dbmetal` AS `mvagy`,
       `metals`.`newPrice` * `personalmetal`.`dbmetal`                                AS `mtej`,
       `personalmetal`.`idpersonalmetal`                                              AS `idpersonalmetal`,
       `metals`.`newPrice`                                                            AS `newPrice`,
       `personalmetal`.`dbmetal`                                                      AS `dbmetal`,
       `personalmetal`.`oldprice`                                                     AS `oldprice`,
       `personalmetal`.`users_id`                                                     AS `users_id`
FROM (`metals` join `personalmetal` on (`metals`.`idmetals` = `personalmetal`.`metals_idmetals`));
...
CREATE
ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `metalszazalek`  AS
SELECT `metals`.`newPrice` / `personalmetal`.`oldprice` * 100 AS `kmet`,
       `personalmetal`.`idpersonalmetal`                      AS `idpersonalmetal`,
       `personalmetal`.`dbmetal`                              AS `dbmetal`,
       `personalmetal`.`oldprice`                             AS `oldprice`,
       `personalmetal`.`users_id`                             AS `users_id`
...
ALTER TABLE `personalcrypto`
  ...
  ADD CONSTRAINT `fk_personalcrypto_users1` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`) ON
DELETE
...
ALTER TABLE `personalmetal`
  ...
  ADD CONSTRAINT `fk_personalmetal_users1` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`) ON
DELETE
NO ACTION ON UPDATE NO ACTION;
